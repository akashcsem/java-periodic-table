...
public class Same_Name extends javax.swing.JFrame {

    Periodic_Table pt = new Periodic_Table();
    int count = 1, xMouse, yMouse;
    String[] img_path = {"", "sn_1.png", "sn_2.png", "sn_3.png", "sn_4.png",  "sn_5.png", "sn_6.png", "sn_7.png", "sn_8.png", "sn_9.png", "sn_10.png"};
    ...
    private void initComponents() {
        ...
        image_viwer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/p/sn_1.png"))); // NOI18N
    ...
    private void minimizeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeMouseClicked
        this.setState(Same_Name.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Same_Name.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
